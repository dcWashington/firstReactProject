...
const mapDispatchToProps = {
    ...
    postFeedback: ( feedbackId, firstName, lastName, phoneNum, email, agree, contactType, feedback) => (postFeedback( feedbackId, firstName, lastName, phoneNum, email, agree, contactType, feedback)),
